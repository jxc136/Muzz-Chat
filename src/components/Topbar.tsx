  ...
  return (
    <>
      <Box className="matched-user-wrapper"
        ...
        <Button variant="contained" onClick={() => setShowControlPanel(!showControlPanel)} sx={{backgroundColor:"#FB406B", fontWeight: "bold" }}>Admin Panel</Button>
      ...
      {showControlPanel && <ControlPanel open={showControlPanel} onClose={() => setShowControlPanel(false)} />}
